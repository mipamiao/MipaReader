...
//        DS.AllBookData.add(new Data()) ;//测试
                ...
                registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), new ActivityResultCallback<ActivityResult>() {
                    ...
                    public void onActivityResult(ActivityResult result) {
                        ...
                        if (result.getData() != null && result.getResultCode() == Activity.RESULT_OK) {
                            ...
                            DS.book_to_first(now_book_index);
    ...
    public void AddBook(String bookname , String bookpath){
        ...
        View view = LayoutInflater.from(IC.getContxt()).inflate(R.layout.load_progress_popwindow,null);
        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        UpdateBookshelf();
                        UpdateBookshelf(DS.AllBookData.size()-1,0);
                        popup.dismiss();
                    }
                });
    ...
    public void InitialBookshelf(){
        BookShelfAdapter bsa = new BookShelfAdapter(DS.AllBookData,IC);
    ...
    public void OpenNovelWindow(int index) {
        ...
        now_book = DS.AllBookData.get(index);
