...
public class DataSet implements Serializable {
    ...
    public static boolean Save(DataSet ds , IndirectClass IC){
        Log.e("金发兽耳小萝莉", "Save: " + IC.getContxt().getFilesDir().getPath()+ File.separator +DataSavePath);
        try {
    ...
    public static DataSet Load(IndirectClass IC){
        DataSet ds;
        Log.e("金发兽耳小萝莉", "Load: " + IC.getContxt().getFilesDir().getPath()+ File.separator +DataSavePath);
        try {
